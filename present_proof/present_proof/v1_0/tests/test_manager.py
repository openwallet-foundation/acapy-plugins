...
from acapy_agent.indy.models.pres_preview import (
    IndyPresAttrSpec,
    IndyPresPredSpec,
    IndyPresPreview,
)
from acapy_agent.indy.models.xform import indy_proof_req_preview2indy_requested_creds
...
class TestPresentationManager(IsolatedAsyncioTestCase):
    async def asyncSetUp(self):
        ...
        mock_executor.get_ledger_for_did = mock.CoroutineMock(
    ...
    async def test_create_bound_request(self):
        ...
        exchange.save = mock.CoroutineMock()
    ...
    async def test_send_presentation_ack_oob(self):
        ...
        with mock.patch.object(
            ...
            messages = responder.messages
            assert len(messages) == 1
            assert mock_retrieve_oob.called
