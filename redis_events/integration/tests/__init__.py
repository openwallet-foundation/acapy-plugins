...
FABER = "http://faber:3001"
ALICE = "http://alice:3001"
RELAY = "http://relay:8071"
...
def post(agent: str, path: str, json: Optional[Any] = None, **kwargs):
    """Post."""
    return requests.post(f"{agent}{path}", json=json, **kwargs)
