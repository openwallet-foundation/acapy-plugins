...
from acapy_agent.config.injector import BaseInjector, InjectionError
from acapy_agent.config.provider import BaseProvider
from acapy_agent.config.settings import BaseSettings
from acapy_agent.core.profile import Profile
from acapy_agent.utils.classloader import ClassNotFoundError, DeferLoad
...
class MultiIndyLedgerManagerProvider(BaseProvider):
    ...
    MANAGER_TYPES = {
        "single-wallet-askar": (
            DeferLoad(
                "indy_ledger.ledger.multiple_ledger."
    ...
    LEDGER_TYPES = {
        "single-wallet-askar": {
            "pool": DeferLoad("indy_ledger.ledger.indy_vdr.IndyVdrLedgerPool"),
            "ledger": DeferLoad("indy_ledger.ledger.indy_vdr.IndyVdrLedger"),
        },
    }
