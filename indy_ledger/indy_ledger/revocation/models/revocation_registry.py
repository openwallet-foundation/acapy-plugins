...
class RevocationRegistry:
    ...
    # For backwards compatibility. How can we remove this?
    def _client_dir(subpath: Optional[str] = None, create: bool = False) -> str:
        ...
        old_dir = _get_dir(".indy_client")

        target_dir = _get_dir(".client")
    ...
    def get_receiving_tails_local_path(self):
        ...
        tails_dir = self._client_dir(join("tails", self.registry_id), create=False)
