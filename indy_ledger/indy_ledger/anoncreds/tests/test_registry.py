...
import pytest
from acapy_agent.anoncreds.base import AnonCredsSchemaAlreadyExists
from acapy_agent.anoncreds.default.legacy_indy import registry as test_module
...
from ...endorse_transaction.v1_0.manager import TransactionManager
from ...endorse_transaction.v1_0.models.transaction_record import TransactionRecord
...
class TestLegacyIndyRegistry(IsolatedAsyncioTestCase):
    ...
    async def test_fix_ledger_entry(self, *_):
        mock_base_ledger = mock.MagicMock(BaseLedger, autospec=True)
        mock_base_ledger.send_revoc_reg_entry = mock.CoroutineMock(
            return_value={
                "rev_reg_def_id": "rev_reg_def_id",
                "signed_txn": "txn",
            }
        )
        mock_base_ledger.get_revoc_reg_delta = mock.CoroutineMock(return_value=({}, 123))
        self.profile.context.injector.bind_instance(
            BaseLedger,
            mock_base_ledger,
        )
