...
T = TypeVar("T", bound="V10PresentationRequestRequestedPredicates")


@attr.s(auto_attribs=True)
class V10PresentationRequestRequestedPredicates:
    """Nested object mapping proof request predicate referents to requested-predicate specifiers"""

    additional_properties: Dict[str, IndyRequestedCredsRequestedPred] = attr.ib(
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        v10_presentation_request_requested_predicates = cls()
        ...
        v10_presentation_request_requested_predicates.additional_properties = (
            additional_properties
        )
        return v10_presentation_request_requested_predicates
