...
from ...models.v10_presentation_request import V10PresentationRequest
...
def _get_kwargs(
    *,
    client: Client,
    pres_ex_id: str,
    json_body: V10PresentationRequest,
) -> Dict[str, Any]:
    url = "{}/present-proof/records/{pres_ex_id}/send-presentation".format(
