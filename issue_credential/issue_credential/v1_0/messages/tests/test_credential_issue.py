...
from ..credential_issue import CredentialIssue, CredentialIssueSchema
...
class TestCredentialIssue(TestCase):
    ...
    @mock.patch.object(CredentialIssueSchema, "load")
    ...
    @mock.patch.object(CredentialIssueSchema, "dump")
