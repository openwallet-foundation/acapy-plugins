...
from ..routes import get_pending_attested_resources, approve_pending_attested_resource, reject_pending_attested_resource
...
class TestLogEntryProtocol(IsolatedAsyncioTestCase):
    ...
    async def test_handler(self):
        context = RequestContext(
            message=WitnessRequest(document=TEST_RECORD)
        )
