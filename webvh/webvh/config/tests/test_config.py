    ...
    async def test_config(self):
        ...
        await set_config(
            self.profile,
            {
                "server_url": TEST_SERVER_URL,
                "witness": False,
                "witness_invitation": f"{TEST_SERVER_URL}?oob=",
            },
        )
        config = await get_plugin_config(self.profile)
        assert config["server_url"] == TEST_SERVER_URL
