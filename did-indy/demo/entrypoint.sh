...
DID_WEB_SERVER_URL=$(curl --silent "${TUNNEL_ENDPOINT}/api/tunnels/command_line" | python -c "import sys, json; print(json.load(sys.stdin)['public_url'])")
# Print the response for debugging purposes
# echo "JSON Response: $RESPONSE"
export DID_WEB_SERVER_URL=${DID_WEB_SERVER_URL}
exec "$@"
